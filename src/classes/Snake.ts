...
export class Snake implements Drawable {
    ...
    constructor(headCoordinates: Coordinates, direction: Direction = Direction.Right) {
    ...
    public isLeavingTheScreen(newHead: Coordinates, gameWidth_cell: number, gameHeight_cell: number): boolean {
        return newHead.x < 0
    ...
    public isCollidingWithObstacle(newHead: Coordinates, snakeMap: SnakeMap): boolean {
